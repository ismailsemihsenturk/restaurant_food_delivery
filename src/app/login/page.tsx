      ...
      <div className='h-full shadow-2xl rounded-md flex flex-col md:flex-row md:h-[70%] md:w-full lg:w-[60%] 2xl:w-[50%]'>
        ...
        <div className='p-10 flex flex-col gap-8 md:w-1/2'>
          ...
          <button className='flex gap-4 p-4 ring-1 ring-orange-100 rounded-md' onClick={() => signIn("google")}>
            <Image src="/google.png" alt="" width={20} height={20} className='object-contain' /> Sign in with Google
          </button>
          <button className='flex gap-4 p-4 ring-1 ring-blue-100 rounded-md'>
            <Image src="/facebook.png" alt="" width={20} height={20} className='object-contain' /> Sign in with Facebook
          </button>
